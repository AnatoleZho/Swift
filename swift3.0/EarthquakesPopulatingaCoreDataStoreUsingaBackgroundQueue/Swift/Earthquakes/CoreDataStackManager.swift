...
class CoreDataStackManager {
    ...
    lazy var applicationSupportDirectory: NSURL = {
        ...
        //
        let supportDirectory = fileManager.URLsForDirectory(.ApplicationSupportDirectory, inDomains: .UserDomainMask).last!
        
        guard let applicationSupportDirectory = supportDirectory.URLByAppendingPathComponent(applicationDocumentsDirectoryName)
